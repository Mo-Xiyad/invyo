...
const CONTENT = {
  ...
  dv: {
    ...
    body1: (
      <>
        މިއީ ދައުވަތު ދެވިފައިވާ ތިޔަފަރާތައް ހާއްސަ ދައުވަތެކެވެ
        <br />
    ...
    body2: (
      <>
        ތިޔަ ފަރާތައް ލިބިވަޑައިގެންނެވި ދައުވަތަކީ ވަކިން ހާއްސަ
        <br />
        ...
        <br />
        <br />
        ތިޔަ ފަރާއް ނޫން ހާއްސަ ދައުވަތު ނެތް ފަރާތް ތަކުން
        <br />
